...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/colcon-ros-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8124&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colcon-ros-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colcon-ros` can be installed with:

```
conda install colcon-ros
```

It is possible to list all of the versions of `colcon-ros` available on your platform with:
